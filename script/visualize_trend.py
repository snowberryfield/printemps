...
def create_distance_chart(trend_data):
    ...
    fig = bokeh.plotting.figure(
        tooltips=TOOLTIPS,
        title="Distance from Reference Solutions",
        x_axis_label="Iteration",
    ...
    fig.line(
        x=trend_data["#iteration"],
        y=trend_data["distance_from_current_solution"],
        legend_label="From Previous Initial",
        width=3,
        color=colors[0],
    )
    ...
    fig.line(
        x=trend_data["#iteration"],
        y=trend_data["distance_from_global_solution"],
        legend_label="From Global",
        width=3,
        color=colors[1],
    )
...
def visualize_trend(trend_data, instance_name, output_file_name):
    ...
    # Distance
    fig_distance = create_distance_chart(trend_data)

    # Parallelization Control
    fig_parallelization_control = create_parallelization_control_chart(trend_data)
