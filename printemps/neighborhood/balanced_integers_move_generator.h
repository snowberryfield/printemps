...
/*****************************************************************************/
#ifndef PRINTEMPS_NEIGHBORHOOD_BALANCED_INTEGERS_MOVE_GENERATOR_H__
#define PRINTEMPS_NEIGHBORHOOD_BALANCED_INTEGERS_MOVE_GENERATOR_H__
...
class BalancedIntegersMoveGenerator
    : public AbstractMoveGenerator<T_Variable, T_Expression> {
   private:
   public:
    /*************************************************************************/
    BalancedIntegersMoveGenerator(void) {
        /// nothing to do
    }

    /*************************************************************************/
    virtual ~BalancedIntegersMoveGenerator(void) {
        /// nothing to do
    }
