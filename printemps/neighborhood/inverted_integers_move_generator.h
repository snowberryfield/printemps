...
/*****************************************************************************/
#ifndef PRINTEMPS_NEIGHBORHOOD_INVERTED_INTEGERS_MOVE_GENERATOR_H__
#define PRINTEMPS_NEIGHBORHOOD_INVERTED_INTEGERS_MOVE_GENERATOR_H__
...
class InvertedIntegersMoveGenerator
    : public AbstractMoveGenerator<T_Variable, T_Expression> {
   private:
   public:
    /*************************************************************************/
    InvertedIntegersMoveGenerator(void) {
        /// nothing to do
    }

    /*************************************************************************/
    virtual ~InvertedIntegersMoveGenerator(void) {
        /// nothing to do
    }
    ...
    void setup(const std::vector<model_component::Constraint<
        ...
        for (auto i = 0; i < BINOMIALS_SIZE; i++) {
            ...
            move.sense = MoveSense::InvertedIntegers;
