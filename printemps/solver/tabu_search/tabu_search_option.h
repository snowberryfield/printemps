...
struct TabuSearchOptionConstant {
    ...
    static constexpr int    DEFAULT_PRUNING_COUNT_THRESHOLD             = 100;
...
struct TabuSearchOption {
    ...
    int      pruning_count_threshold;                      // hidden
    ...
    void initialize(void) {
        ...
        this->pruning_count_threshold =
            TabuSearchOptionConstant::DEFAULT_PRUNING_COUNT_THRESHOLD;
