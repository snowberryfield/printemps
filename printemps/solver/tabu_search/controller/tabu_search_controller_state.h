...
struct TabuSearchControllerState {
    ...
    solution::SparseSolution<T_Variable, T_Expression> pending_solution;
    ...
    int employing_pending_solution_count_after_relaxation;
    ...
    InitialSolutionMode          initial_solution_mode;
    PenaltyCoefficientUpdateMode penalty_coefficient_update_mode;
    ...
    void initialize(void) {
        ...
        this->pending_solution.initialize();
        ...
        this->employing_pending_solution_count_after_relaxation  = 0;
        ...
        this->initial_solution_mode = InitialSolutionMode::Global;
        this->penalty_coefficient_update_mode =
            PenaltyCoefficientUpdateMode::Keep;
        this->search_mode = SearchMode::Intensify;
